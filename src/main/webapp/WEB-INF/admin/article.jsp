						...
						<div class="tab-content" id="tab2">
								...
								<form action="${ctx}/admin/article/add" method="post" id="mainform">
                                    ...
                                    <P id="previewImgP" style="display:none">
                                        ...
                                        <input class="button setBtnWidth" type="button" value="上传" onclick="uploadimage()" style="width:50px;" id="uploadImg"/><br/>
                                        <img  width="725px" height="150px" src="" id="imgUrlAddress"  />
                                    </P>
									<p>
