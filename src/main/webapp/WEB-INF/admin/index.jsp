...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="body-wrapper">
		<div id="sidebar">
			...
			<ul id="main-nav">
                <li>
                    ...
                    <ul>
                        <li><a href="javascript:load('${ctx}/admin/queryNewsAndPosterList')">更新滚动或新闻图片</a></li>
                    </ul>
                </li>
				<li>
					<a href="#" class="nav-top-item">
				...
				<c:if test="${admin.userType==2}">
					<li>
						...
						<ul>
							...
							<li><a href="javascript:load('${ctx}/admin/userManagerUI?curPage=1');">人员管理</a></li>
						</ul>
					</li>    
				</c:if>
			</ul>
		...
		<div id="main-content">
			...
			<h2>欢迎${sessionScope.admin.username}进入后台管理系统</h2>
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="javascript:load('${ctx}/admin/queryNewsAndPosterList')"><span>
