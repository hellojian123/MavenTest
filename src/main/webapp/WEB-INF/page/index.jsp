...
<div class="wrap">
	...
	<div id="service">
		...
		<ul>
			<li><a href="${ctx}/article/Service?typeid=7"><img src="${ctx}/matter/images/ser1.jpg" alt=""/><br>

				<p>网站建设</p></a></li>
			<li><a href="${ctx}/article/Service?typeid=8"><img src="${ctx}/matter/images/ser1.jpg" alt=""/><br>

				<p>客户端建设服务</p></a></li>
			<li class="no_margin"><a href="${ctx}/article/Service?typeid=9"><img src="${ctx}/matter/images/ser1.jpg"
																																					 alt=""/><br>
		...
		<div class="cop">
			...
			<ul>
				<c:forEach var="newsList" items="${newsList}" varStatus="status">
					<li><a href="${ctx}/article/getArticleById?articleId=${newsList.id}"
								 target="_blank">${newsList.title}</a><span><fmt:formatDate value="${newsList.modifyDate}"
																																						pattern="hh-MM-ss"/></span></li>
				</c:forEach>
			</ul>
		</div>
		<div class="comp">
